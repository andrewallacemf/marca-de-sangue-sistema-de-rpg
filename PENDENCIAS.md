...
| **Habilidades de custo fixo de PA** (~20: Esmagar, Auto cura, Confundir, etc.) — rebalancear proporcionalmente ao novo total de PA (fila, logo após o núcleo) | [listas/habilidades-base-*](sistema-base/listas/) | IA + grupo | 2026-07-12 |
| **Armaduras — modelagem por peça**: revisar as regiões cobertas (💡 proposta atual = tronco + 2 braços) e criar peças de outras regiões (pernas, cabeça, mãos, pés); revisar os redutores de dano por peça | [listas/protecoes-base.md](sistema-base/listas/protecoes-base.md) | grupo | 2026-07-12 |
| **Armas com dado de dano aplicado em 12/07** (proposta 💡): revisar arma por arma, em especial as **mistas ⚠️** (contundente + cortante/perfurante) e o "Mangual pesado…" (nome contundente, ficou 1 dado); depois validar no playtest | [listas/equipamentos-base.md](sistema-base/listas/equipamentos-base.md) | grupo | 2026-07-12 |
| Habilidades de **"metade do dano da arma"** (Atordoar, Encontrão, Quebrar guarda…): definir arredondamento agora que o dano é em dados (metade do resultado rolado) | [listas/habilidades-base-fisicas.md](sistema-base/listas/habilidades-base-fisicas.md) | grupo | 2026-07-12 |
