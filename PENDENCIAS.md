...
| Efeitos que **operam sobre o dano da arma** agora que ele é dado: "metade do dano" (Atordoar, Encontrão, Quebrar guarda) e "dobra o dano" (aspecto Emboscador) — definir se é sobre o resultado rolado (e o arredondamento) ou sobre os dados | [listas/habilidades-base-fisicas.md](sistema-base/listas/habilidades-base-fisicas.md), [listas/tracos-base.md](sistema-base/listas/tracos-base.md) | grupo | 2026-07-12 |
...
| Revisar o experimental social: entradas de atributo **Mental** sob o título "sociais"; "Agilizar derrota" sem a variável "x"; "Sinergia" truncada; mistura "campo"/"trilha" | [listas/habilidades-experimentais-sociais.md](sistema-base/listas/habilidades-experimentais-sociais.md) | grupo | 2026-07-12 |
