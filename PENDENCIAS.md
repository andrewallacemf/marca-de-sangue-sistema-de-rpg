...
| Pendência | Onde | Quem | Desde |
|-----------|------|------|-------|
| **Durabilidade — valores** (a *regra* já está fechada — ver [Durabilidade das proteções](sistema-base/listas/protecoes-base.md#durabilidade-das-proteções) e [Durabilidade das armas](sistema-base/listas/equipamentos-base.md#durabilidade-das-armas)): preencher os **valores de durabilidade das armas** (coluna vazia) e **calibrar** os valores de armas/armaduras/escudos no playtest. Referências: valores da v0.4.1 (escudos/armaduras) e a escala das armas de fogo do Colapso | [listas/equipamentos-base.md](sistema-base/listas/equipamentos-base.md), [listas/protecoes-base.md](sistema-base/listas/protecoes-base.md) | grupo | 2026-07-12 |
| **Traços/habilidades de durabilidade** (💡 propostas da IA, 19/07 — a decidir): reduzir a perda de durabilidade, reparar equipamento em campo, e ataques que forçam perda extra no equipamento do alvo | [listas/tracos-base.md](sistema-base/listas/tracos-base.md), [listas/habilidades-base-fisicas.md](sistema-base/listas/habilidades-base-fisicas.md) | André/grupo | 2026-07-19 |
