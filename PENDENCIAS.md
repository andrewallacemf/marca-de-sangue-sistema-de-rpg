...
| **Habilidade "esconder-se dentro do campo de visão"** (gancho do módulo de furtividade): criar a habilidade que permite tentar se esconder mesmo à vista de um inimigo | [conflitos/05-furtividade.md](sistema-base/conflitos/05-furtividade.md) (Ganchos) | grupo | 2026-07-19 |
...
| **Flecha de madeira `1d4` × flecha de ferro `1d6`** (playtest 2): padronizar na lista de equipamentos/munição e alinhar as fichas de arqueiros (hoje há "1d4 flecha de ferro" em fichas) | [listas/equipamentos-base.md](sistema-base/listas/equipamentos-base.md) | grupo | 2026-07-19 |
