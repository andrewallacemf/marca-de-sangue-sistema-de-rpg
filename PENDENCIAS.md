...
| Aspecto **Firme** herdou a progressão de 4 passos da antiga Versatilidade — conflita com a regra "traços não possuem níveis"; decidir: traços encadeados, exceção evolutiva ou efeito único | [listas/tracos-base.md](sistema-base/listas/tracos-base.md) | grupo | 2026-07-11 |
