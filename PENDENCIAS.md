...
| **Dano à distância / munição** — com o dano corpo a corpo subindo, decidir se a **munição** (flecha madeira `1d4`, ferro `1d6`?, bala `1d8`) e as armas à distância também sobem, para não ficarem defasadas; padronizar **flecha de madeira `1d4` × flecha de ferro `1d6`** | [listas/equipamentos-base.md](sistema-base/listas/equipamentos-base.md), [fichas de arqueiros] | grupo | 2026-07-19 |
