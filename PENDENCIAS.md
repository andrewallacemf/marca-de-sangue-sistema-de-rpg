...
| **Fase C — coleção `armas` (aprovar e executar)**: mover os catálogos de arma/proteção para módulos por família (`armas-brancas`, `armas-exoticas`, `arcos-e-bestas`, `armas-de-fogo`, `protecoes`), mantendo o *sistema* no núcleo. Análise de impacto e proposta prontas | [notas-de-design/proposta-modulos-armas.md](notas-de-design/proposta-modulos-armas.md) | André/grupo | 2026-07-19 |
