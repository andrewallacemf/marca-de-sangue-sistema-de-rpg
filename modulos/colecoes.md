...
| Coleção | Módulos | Observação |
|---------|---------|------------|
| *(nenhuma ainda)* | | Prevista: coleção **armas** (armas-de-fogo + armas-marciais + armas-exóticas), conforme decisão de 11/07/2026. |

*Regras de organização: [CONVENCOES.md](../CONVENCOES.md), seção 10.*
