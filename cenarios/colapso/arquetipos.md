...
Cada papel **dá nome e flavor** a um [arquétipo genérico](../../sistema-base/arquetipos/00-como-funcionam.md)
do núcleo (ou é próprio, quando usa uma mecânica do cenário como veículos/mutações). Seguem a
[estrutura de arquétipo](../../sistema-base/arquetipos/00-como-funcionam.md).

> 🧭 **Esqueleto para o Gabriel completar** (sugestões definitivas, habilidades de caminho,
> descrição de mundo).

| Papel (Colapso) | Base (genérico) | Flavor / ajuste |
|---|---|---|
