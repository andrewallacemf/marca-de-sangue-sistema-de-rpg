...
A radiação transforma quem sobrevive a ela. Há duas linhas: **Cromática** (mais branda; algumas
mutações trazem benefício e revés ao mesmo tempo) e **Púrpura** (só revezes severos). Um
personagem suporta **até 5 mutações**; ao contrair a **6ª, morre**. Os efeitos **não são
consumíveis** e funcionam automaticamente sempre que aplicáveis.

> 🧩 **Candidato a módulo `mutacoes`.** Por ora fica no cenário; promover se outro mundo adotar
> mutações.

## Contraindo mutação

Ao sofrer dano de radiação (ver [radiação](radiacao.md)), faz-se um **teste de qualquer
atributo**, podendo usar quantas [aptidões](../../../sistema-base/conceitos/04-aptidoes.md)
quiser. A **dificuldade = quantidade de dano sofrido**. Passou: nada acontece. Falhou: sorteia —
**1d100** para dano **Cromático**, **1d12** para dano **Púrpura**.

*Exemplo: 3 de dano cromático → dificuldade 3. O teste tira 2 (falha) → rola 1d100 → 29 →
"Bússola".*

## Adquirindo mutação de propósito

Só na **criação de personagem**. O custo é pago em **pontos de dano permanente** (a mutação diz
onde). Mutações adquiridas contam no total de 5.

## Mutações Cromáticas (1d100)
...
| 18 | Imã (a cada sucata comum acha +1; **contra:** +1 PA para mover perto de grandes metais) | — |
| 19 | Orelhas retráteis (escondem-se na pele; só evita água nos ouvidos) | — |
...
| 61 | Pele de lagarto | — |
| 62 | Ecolocalização (localiza-se como morcego; **contra:** status *Confuso* em ambientes barulhentos) | — |
| 63 | Adquire a mutação acima 👆 | — |
| 64 | Adquire a mutação abaixo 👇 | — |
| 65 | Carapaça (1 de escudo natural no tronco, regenera em descanso longo; **contra:** +2 PA para se levantar) | — |
| 66 | Adquire a mutação acima 👆 | — |
| 67 | Adquire a mutação abaixo 👇 | — |
| 68 | Camuflagem | — |
| 69 | Condutor | — |
| 70 | Adquire a mutação acima 👆 | — |
| 71 | Adquire a mutação abaixo 👇 | — |
| 72 | Perna de sapo (dobra saltos; **contra:** dobro de PA para andar sem saltar; não pula com uma perna só) | — |
...
| 84 | Nanismo (−30 cm de altura) | 1 dano perm. no tronco |
| 85 | Gigantismo (+30 cm de altura) | 1 dano perm. no tronco |
| 86 | Adquire a mutação acima 👆 | — |
| 87 | Adquire a mutação abaixo 👇 | — |
| 88 | Exoesqueleto | — |
| 89 | Bioluminescência | — |
| 90 | Adquire a mutação acima 👆 | — |
| 91 | Adquire a mutação abaixo 👇 | — |
| 92 | Pele oleosa (vantagem em espaços apertados; **contra:** dificuldade de segurar objetos) | — |
| 93 | Visão térmica (vê calor a até 3 m, através de obstáculos) | 1 dano perm. na cabeça |
| 94 | Adquire a mutação acima 👆 | — |
| 95 | Adquire a mutação abaixo 👇 | — |
| 96 | Impermeabilização (líquidos não tocam a pele; não impede beber) | — |
| 97 | Botijão (cheiro constante de gás; não expele gás inflamável) | — |
| 98 | Adquire a mutação abaixo 👇 | — |
| 99 | Fragmentado (confusão mental leve; pode receber status *Confuso* em momentos definidos pelo Mestre) | — |
| 100 | Meia-vida (sorteia 2 mutações cromáticas) | não comprável |

## Mutações Púrpuras (1d12)
