...
**Traços de caminho (≥ 2 do caminho):** [Iaijutsu](mecanicas-unicas/habilidades-do.md#iaijutsu-traço-de-caminho) (Aspecto, saca uma arma embainhada sem gastar `PA` — substitui o antigo dō avulso "Iaijutsu — Caminho do Corte Rápido").

> ⚠️ A regra de desvantagem por trocar de arma que o Iaijutsu ignorava foi removida do sistema-base em 27/07/2026 — o traço está com pendência de revisão, ver [habilidades-do.md#iaijutsu-traço-de-caminho](mecanicas-unicas/habilidades-do.md#iaijutsu-traço-de-caminho) e `PENDENCIAS.md`.
...
- **Técnicas:** [Esconder-se](../../sistema-base/listas/tracos-base.md), [Realizar truques](../../sistema-base/listas/tracos-base.md) — a ação permite esconder manipulações breves por destreza ou blefe; a Técnica anula somente sua desvantagem natural.
