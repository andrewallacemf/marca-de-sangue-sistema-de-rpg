...
Completar um objetivo que o grupo precisa alcançar garante experiência de acordo com sua dificuldade e duração. **Tarefas** acontecem em uma única sessão e possuem pouca margem para fracasso, **missões** tendem a demorar de 2 a 3 sessões para serem realizadas e existe boa chance de falha, **arcos narrativos** demoram entre 4 e 6 sessões (ou até mais) e tem grandes chances de fracasso.
