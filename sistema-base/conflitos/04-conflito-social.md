...
> ⚠️ A DEFINIR: exemplo incompleto no manual original.
...
**Conflitos moderados:** 5 turnos;

**Conflitos complexos:** 7 turnos.
...
**Efeito:** Inicia um teste e contrateste. O vencedor movimenta o alvo na direção desejada.
...
**Efeito: Inicia um teste e contrateste.** Permite ao personagem reposicionar-se estrategicamente na malha.
...
> ⚠️ A DEFINIR: há uma variante pendente sobre os pontos para vitória (5 vs 10 por personagem) — ver [notas-de-design/variantes-pendentes.md](../../notas-de-design/variantes-pendentes.md) (item 1).
