...
As **regras universais** do Marca de Sangue — as que valem para qualquer cenário. Tudo o
que é específico de um mundo (Colapso, Mukashi, Gaéria…) mora em `../cenarios/`, não aqui.

**Fonte:** este conteúdo foi migrado do Manual básico **v1.1.0b** (Notion) em 2026-07-11.
...
Se uma regra só faz sentido em **um** mundo, ela **não** é do sistema-base — é de cenário.
O base é o esqueleto comum sobre o qual os cenários se apoiam.
