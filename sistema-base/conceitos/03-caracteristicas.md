...
cenario: base
status: estavel
tags: [caracteristicas, cartas, exp, compra]
...
Além das características básicas disponíveis no manual de regras básicas, outras características, assim como as armas e armaduras, são definidas com base no cenário em que o jogo se passa.

As próximas seções disponibilizam um conjunto de Aptidões, Habilidades e Traços genéricos que podem ser adaptados ao contexto que você preferir jogar.

## Jogando com ou sem cartas

O sistema do Marca de Sangue foi pensado para possibilitar que as habilidades sejam usadas em cartas, dando a sensação de um jogo de “deck building”. Mas não se preocupe! Se você não tiver à disposição o conjunto físico do jogo e as cartas impressas, você ainda vai conseguir jogar. Para isso, disponibilizamos no final deste manual um modelo de ficha de personagem contendo espaços a serem preenchidos com as informações das habilidades adquiridas por seu personagem.

Contudo, consideramos que o uso das cartas proporciona uma experiência completa, dinâmica e com menos "burocracia" na hora de jogar.

> 💡 **Jogando com Cartas: Características**
> Cada característica do seu personagem é descrita por uma carta. Assim, no decorrer de sua (às vezes curta) trajetória, o jogador vai construindo um baralho que representa o conjunto de habilidades, aptidões e traços de seu personagem.
...
> 💡 **Utilizando traços usando ficha**
> Para utilizar um traço com suporte de ficha, basta transcrever o traço para a área “traços” na ficha do jogador para consultar sempre que for necessário.
