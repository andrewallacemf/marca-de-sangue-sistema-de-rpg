...
### Habilidades dentro de combate

**Habilidades podem ser utilizadas como ações em seu turno gastando os pontos de ação indicados ou programados com gatilhos (custando `1 PA` adicional).**
...
Fora de uma batalha, o jogador pode indicar a utilização de uma habilidade por vez, respeitando a lógica básica de tempo necessário para realizar a habilidade indicada. Cabe ao narrador dizer se a habilidade pode ser utilizada no momento e da forma como o jogador indicou.
