...
linhas=[
 ...
 "",
 "Vida (PV): cada membro tem 10 PV. Ordem do dano: superficial → profundo → permanente. Um membro fica",
 "INCAPACITADO com 10 de dano profundo. Anote o total de dano no membro atingido.",
