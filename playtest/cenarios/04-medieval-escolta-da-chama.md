...
O **Arauto da Chama** carrega o último fogo sagrado até o santuário na outra ponta da
ponte antiga. Ele é frágil e não sabe lutar. Bandidos emboscam a estrada de vários lados.
Levem o Arauto vivo até o santuário. Foco tático: **defesa, proteção de aliado e controle
de área** ao redor de um alvo que precisa ser mantido em pé.
...
- **Terreno:** as margens da ponte são despenhadeiro — cair = fora de cena por 1 rodada
  (tem de escalar de volta). Empurrar inimigos para fora da ponte é válido e poderoso.

## O Arauto (NPC a proteger)

- **PA 8 · PV 60** · sem armas · **anda com o grupo** (o narrador o move, ou um jogador o
  guia com Comandar). O Arauto **não ataca** e defende com desvantagem. Se ele for
  incapacitado (tronco/cabeça) ou cair da ponte e não for resgatado em 1 rodada, a chama
  se apaga.

## Inimigos (em ondas)

- **Onda 1 (estrada, antes da ponte):** 3 **Bandidos** — PA 10 · espada curta (média,
  cortante 1d8, 4 PA).
- **Onda 2 (na ponte):** 2 **Bandidos** + 1 **Arqueiro** — Arqueiro PA 10 · arco composto
  (média, 4 PA, alcance 7–10 m, flecha 1d4) · atira no **Arauto** de longe.
- **Onda 3 (perto do santuário):** 1 **Chefe de bando** — PA 10 · machado de batalha
  (pesada, cortante 1d12, 6 PA) · peitoral médio (−2) · tenta agarrar/derrubar o Arauto.

## Objetivo

- **Vitória:** o Arauto chega vivo ao santuário.
- **Derrota:** o Arauto é incapacitado ou a chama se apaga.

## Dica de teste

Este é o teste de **Protetor, Grito de alerta e controle de área**. Veja se dá para
formar um "casulo" em volta do Arauto e se o Arqueiro (que ignora a linha de frente
mirando o NPC) cria a tensão certa. Empurrar inimigos da ponte deve ser uma jogada boa.
